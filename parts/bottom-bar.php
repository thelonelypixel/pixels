...
<div class="column column-m-12">
		...
		<div class="site-footer__column">
			...
			<ul class="footer-socials">
				...
				<li class="social--twitter">
					<a href="<?php the_field('twitter', 'options'); ?>" target="_blank" aria-label="Visit twitter.com (opens in a new window)">
				...
				<li class="social--facebook">
					<a href="<?php the_field('facebook', 'options'); ?>" target="_blank" aria-label="Visit facebook.com (opens in a new window)">
				...
				<li class="social--linkedin">
					<a href="<?php the_field('linkedin', 'options'); ?>" target="_blank" aria-label="Visit linkedin.com (opens in a new window)">
				...
				<li class="social--youtube">
					<a href="<?php the_field('youtube', 'options'); ?>" target="_blank" aria-label="Visit youtube.com (opens in a new window)">
	...
	<div class="site-footer__bottom">
		...
		<a class="credits" href="https://thelonelypixel.co.uk" title="Freelance Web Designer - The Lonely Pixel">
			<div>Credits</div>
